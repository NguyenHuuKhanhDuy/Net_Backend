        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RuleData = table.Column<string>(type: "jsonb", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Alpha3Code = table.Column<string>(type: "character(3)", fixedLength: true, maxLength: 3, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false, defaultValueSql: "gen_random_uuid()"),
                    BaseCurrencyCode = table.Column<string>(type: "varchar(10)", nullable: false),
                    QuoteCurrencyCode = table.Column<string>(type: "varchar(10)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CurrencyRate_Currency_BaseCurrencyCode",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CurrencyRate_Currency_QuoteCurrencyCode",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Fee = table.Column<decimal>(type: "numeric", nullable: false),
                    FeeType = table.Column<int>(type: "integer", nullable: false),
                    PayerFeeType = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "now()")
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CurrencyCode = table.Column<string>(type: "varchar(10)", maxLength: 10, nullable: false),
                    Balance = table.Column<decimal>(type: "numeric(20,8)", nullable: false, defaultValue: 0m),
                    PendingBalance = table.Column<decimal>(type: "numeric(20,8)", nullable: false, defaultValue: 0m),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantWallet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantWallet_Currency_CurrencyCode",
                        column: x => x.CurrencyCode,
                        principalSchema: "payment",
                        principalTable: "Currency",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TenantWallet_Tenant_TenantId",
                        column: x => x.TenantId,
                        principalSchema: "payment",
                        principalTable: "Tenant",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TenantCurrencyCode = table.Column<string>(type: "varchar(10)", nullable: false),
                    UserCurrencyCode = table.Column<string>(type: "varchar(10)", nullable: true),
                    ...
                    PayerFeeType = table.Column<int>(type: "integer", nullable: true),
                    NetAmount = table.Column<decimal>(type: "numeric(20,8)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentTransaction_Currency_TenantCurrencyCode",
                        column: x => x.TenantCurrencyCode,
                        principalSchema: "payment",
                        principalTable: "Currency",
                        principalColumn: "Code",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PaymentTransaction_Currency_UserCurrencyCode",
                        column: x => x.UserCurrencyCode,
                        principalSchema: "payment",
                        principalTable: "Currency",
                        principalColumn: "Code");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PaymentTransaction_TenantCredentials_TenantCredentialId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Amount = table.Column<decimal>(type: "numeric(20,8)", nullable: false),
                    BalanceBefore = table.Column<decimal>(type: "numeric(20,8)", nullable: false),
                    BalanceAfter = table.Column<decimal>(type: "numeric(20,8)", nullable: false),
                    Direction = table.Column<int>(type: "integer", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TenantWalletAudit", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TenantWalletAudit_TenantWallet_WalletId",
                        column: x => x.WalletId,
                        principalSchema: "payment",
                        principalTable: "TenantWallet",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrencyRate_QuoteCurrencyCode",
                schema: "payment",
                table: "CurrencyRate",
                column: "QuoteCurrencyCode");

            migrationBuilder.CreateIndex(
                name: "uq_currency_rate",
                schema: "payment",
                table: "CurrencyRate",
                columns: new[] { "BaseCurrencyCode", "QuoteCurrencyCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransaction_TenantCredentialId",
                schema: "payment",
                table: "PaymentTransaction",
                column: "TenantCredentialId");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransaction_TenantCurrencyCode",
                schema: "payment",
                table: "PaymentTransaction",
                column: "TenantCurrencyCode");

            migrationBuilder.CreateIndex(
                name: "IX_PaymentTransaction_UserCurrencyCode",
                schema: "payment",
                table: "PaymentTransaction",
                column: "UserCurrencyCode");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantWallet_CurrencyCode",
                schema: "payment",
                table: "TenantWallet",
                column: "CurrencyCode");

            migrationBuilder.CreateIndex(
                name: "IX_TenantWallet_TenantId_CurrencyCode",
                schema: "payment",
                table: "TenantWallet",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantWalletAudit_RelatedType",
                schema: "payment",
                table: "TenantWalletAudit",
                column: "RelatedType");

            migrationBuilder.CreateIndex(
                name: "IX_TenantWalletAudit_TransactionId",
                schema: "payment",
                table: "TenantWalletAudit",
                column: "TransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_TenantWalletAudit_WalletId",
                schema: "payment",
                table: "TenantWalletAudit",
                column: "WalletId");
